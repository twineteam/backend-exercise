...
import pytest
from source_spacex.source import SpacexStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SpacexStream, "path", "v0/example_endpoint")
    mocker.patch.object(SpacexStream, "primary_key", "test_primary_key")
    mocker.patch.object(SpacexStream, "__abstractmethods__", set())
